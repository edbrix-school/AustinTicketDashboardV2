...
function Index() {
    ...
    return (
        <>
            <PageLayout topTab={true} pageTitle="Reports" parentPageName="Reports" pageName='Reports' >
                <div className=''>
                    ...
                    <div className='grid grid-cols-12 gap-[45px] xl:gap-[2.344vw] mt-[32px] xl:mt-[1.667vw]'>
                        <div onClick={() => setAssetsPopupShow(true)} className='col-span-12 md:col-span-6 xl:col-span-3'>
