    ...
    return (
        ...
        <div>
            <Sidebar visible={props.visible} position="right" className="custmSidebar width1600" onHide={() => props.onHides(false)}>
                ...
                <div className="absolute top-0 left-0 vertical-shadow 3xl:pl-[1.667vw] 3xl:pt-[1.667vw] pl-8 pt-8">
                ...
                <div className='absolute bottom-0 left-0'><Image src={'/assets/images/horizontal-shadow.svg'} width={1600} height={269} className="w-full" /></div>
                </div>
                {/*Map view */}
            </Sidebar>
