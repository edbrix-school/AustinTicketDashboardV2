...
const ComputerPage = () => {
  ...
  return (
    <PageLayout topTab={true} pageTitle="E-Library" pageName={pageName}>
      ...
      <Link href={"/technician/elibrary/allison/computer/srpage"} className="bg-white shadow-[0px 1px 2px 0px] shadow-[rgba(0,0,0,0.08)] rounded-lg xl:rounded-[0.521vw] xl:p-[1.042vw] p-5 relative">
