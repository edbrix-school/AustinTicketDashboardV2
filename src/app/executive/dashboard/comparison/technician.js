                    ...
                    <table className="text-[14px] xl:text-[0.729] custCompareTable w-full">
                        ...
                        <tbody>
                            <tr>
                                ...
                                Number of New Tickets Recieved (Fresh)
                                </td>
                                <td width='433' >1500&nbsp;&nbsp;&nbsp;<span className="font-semibold">(13%)</span></td>
                                <td width='433'>1200</td>
                                <td width='433'>1500</td>
                            </tr>
                            <tr>
                                <td >
                                Number of Re-Assigned Tickets
                                </td>
                                <td width='433'>400</td>
                                <td width='433'>300</td>
                                <td width='433'>100</td>
