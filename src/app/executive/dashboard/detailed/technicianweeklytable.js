...
export default function TechnicianWeeklyTable() {
    // Data table
  ...
  const [filters, setFilters] = useState(null);
    ...
    const headerGroup = (
        <ColumnGroup>
            <Row>
                <Column colSpan={9} />
                <Column header="Week 1" colSpan={3}  align="center" headerClassName="custmheading first_position"  />
                <Column header="Week 2" colSpan={3}  align="center" headerClassName="centercustmheading center_position" />
                <Column header="Week 3" colSpan={3} align="center" headerClassName="custmheading last_position"  />
            </Row>
