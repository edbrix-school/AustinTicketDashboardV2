    ...
    <>
     <div>
                ...
                <div className="xl:px-[2.604vw] px-10 xl:space-y-[1.875vw] space-y-8">
                    ...
                    <div className="flex items-center justify-center"><Link href={''} onClick={() =>props.onHides(false)}  className="text-[#FFFFFF] font-normal leading-[18px] xl:leading-[0.938vw] text-[14px] xl:text-[0.729vw] py-[10px] xl:py-[0.521vw] px-[12px] xl:px-[0.625vw] bg-[#1570EF] rounded-lg">Done</Link></div>
                </div>
