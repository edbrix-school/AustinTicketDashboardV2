  ...
  return (
    <>
      <Sidebar
        ...
        blockScroll={true}
        onHide={props.onHide}
        className="w-[922px] xl:w-[48.021vw] custmSidebar rounded-lg"
      >
        <div className=" ">
          <div className="header pl-[15px] pt-[8px]  ">
            <div className="text-[24px] font-semibold text-[#20232E] xl:text-[1.25vw] min-h-[20px] xl:min-h-[1.823vw]  ">
              Assets
            </div>
            <div className="text-[16px] text-[#20232E] xl:text-[0.833vw] min-h-[20px] xl:min-h-[1.823vw">
          ...
          <div className="space-y-3 p-4 pt-[24px]">
            <div className="grid gap-5 grid-cols-2  cursor-pointer">
              <div className="border border-[#E4E7EC] rounded-lg p-3 hover:bg-[#E4E7EC] parent-div hover:border-[#d1d5db]">
                <div className="text-[18px] text-[#3A3E49] xl:text-[0.938vw] min-h-[20px] xl:min-h-[1.042vw]  child-div">
                  Assets by Type/Status
                </div>
                <div className="text-[14px] text-[#84878D] xl:text-[0.729vw] min-h-[25px] xl:min-h-[1.302vw]">
                  {" "}
            ...
            <div className="grid gap-5 grid-cols-2 cursor-pointer">
              <div className="border border-[#E4E7EC] rounded-lg p-3 hover:bg-[#E4E7EC] parent-div  hover:border-[#d1d5db]">
                <div className="text-[18px] text-[#3A3E49] xl:text-[0.938vw] min-h-[20px]  xl:min-h-[1.823vw] child-div">
                  Assets Logs
                </div>
                <div className="text-[14px] text-[#84878D] xl:text-[0.729vw] min-h-[25px] xl:min-h-[1.563vw]">
                  {" "}
