   ...
   <Sidebar visible={props.visible}
          ...
          <div className="font-medium">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-2 gap-4 xl:gap-[1.67vw] gap-y-4 xl:gap-y-[0.689vw]">
                        ...
                        <div className="flex flex-col  w-full custDropdownbox">
                            ...
                            <Dropdown value={selectedCity} onChange={(e) => setSelectedCity(e.value)} options={cities} optionLabel="name"
                                placeholder="--Select--" className="w-full md:w-14rem border" />
            ...
            <div className="absolute bottom-5 right-5 flex justify-end gap-2">
                <div><Link href={'/technician/dashboard'} className="text-[#4B586E] border border-[#BECDE3] font-normal leading-[18px] xl:leading-[0.938vw] text-[14px] xl:text-[0.729vw] py-[10px] xl:py-[0.521vw] px-[12px] xl:px-[0.625vw] rounded-lg">Cancel</Link></div>
                <div><Link href={'/technician/dashboard'} className="text-[#FFFFFF] font-normal leading-[18px] xl:leading-[0.938vw] text-[14px] xl:text-[0.729vw] py-[10px] xl:py-[0.521vw] px-[12px] xl:px-[0.625vw] bg-[#1570EF] rounded-lg">Create</Link></div>
            </div>
</Sidebar>
   </div>
   </>
