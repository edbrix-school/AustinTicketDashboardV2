      ...
      <div className="flex gap-4 items-center">
        <div className="w-full min-h-[65px] xl:min-h-[3.65vw] bg-white flex flex-wrap justify-between rounded-[8px] xl:rounded-[0.417vw] dark:bg-[#191A1E] pl-2 xl:pl-[0.833vw] xl:pr-[0.833vw] pr-2 shadow">
          <div className="flex flex-wrap justify-start items-center gap-1 pt-2 pb-1 xl:py-1">
            <div className=" lg:w-auto w-full">
              <div className="flex flex-wrap gap-[4px] items-center">
                ...
                <div className="rounded pb-[4px] px-[12px] space-y-0 cursor-pointer max-w-[65px] hover:max-w-[90px] ease-in duration-300 overflow-hidden bg-[#F9F9FC] dark:bg-[#24262D]">
          ...
          <div className="flex xl:justify-end gap-2 xl:py-0 pt-1 pb-2 xl:w-auto w-full items-center">
            ...
            >
              <i className="asetsmng-arrow-left-line text-[12px] text-[#84878D] dark:text-[#B3B9C6] group-hover:text-[#4169E1]"></i>
              <div className="text-[#84878D] dark:text-[#B3B9C6] group-hover:text-[#4169E1] text-[12px] font-normal leading-tight">
                <div className={myworksans.className}>
                  Applied <br /> Filters
                </div>
              </div>
            </Link>
            <div className="rounded-r-[8px] xl:rounded-r-[0.417vw] flex items-center justify-center gap-2 px-[12px] xl:px-[0.833vw] py-[8px] xl:py-[0.730vw] bg-[#4169E1] xl:w-auto w-1/2 cursor-pointer"
